...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        //self.contentMode = UIViewContentModeRedraw; // wont work because view from storyboard
        [self setup];
    }
    return self;
}
...
{
    CGContextRef context = UIGraphicsGetCurrentContext(); // get context for Core Graphics
    
    
    // build method to draw circle
    // draw face (circle)
    // draw eyes (2 circles)
    // no nose
    // draw mouth
